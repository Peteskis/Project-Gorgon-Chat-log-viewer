...
Also added an on-screen Tips tab, per-channel pop-out windows, and phrase trimming so you can choose to speak only the text before or after a matched phrase. (Coming soon -  Combat Summary. Per Mob Skills/Damage)
